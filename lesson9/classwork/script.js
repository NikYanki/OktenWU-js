...
for (let simpson of simpsons) {
    ...
    divSimpson.innerText = `${simpson.name} ${simpson.age} ${simpson.info}`;
...
for (let simpson of simpsons) {
    ...
    divSimpson.appendChild(divSurname);
    divSimpson.appendChild(divage);
    divSimpson.appendChild(pInfo);
    divSimpson.appendChild(imgPhoto);
    document.body.append(divSimpson);
...
for (let coursesArrayElement of coursesArray) {
    ...
    for (let coursesArrayElementElement of coursesArrayElement.modules) {
        ...
        liModules.innerText = coursesArrayElementElement
        ulModules.appendChild(liModules)

    }
    parrentDiv.append(h2Title, divMonthDuration, divHourDuration, ulModules)
